...
def main():
    ...
    parser.add_argument("--output_json", type=str, default="gemini_labels_with_qwen_2B.json")
    parser.add_argument("--events_jsonl", type=str, default="gemini_labels_qwen_events_2B.jsonl")
