...
def main():
    ...
    parser.add_argument("--output_json", type=str, default="human_labels_with_qwen.json")
    parser.add_argument("--events_jsonl", type=str, default="human_labels_qwen_events.jsonl")
